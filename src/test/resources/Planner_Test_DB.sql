...
INSERT INTO `account` (`account_id`, `email`, `password`, `name`, `nickname`, `phone`, `image`, `create_date`, `update_date`) VALUES (1,'test@naver.com','12345678','test','test','01012345678','Account\\user.png','2022-10-29 20:42:02','2022-10-29 20:42:02');
...
INSERT INTO `review` (`review_id`, `planner_id`, `title`, `writer`, `content`, `like_count`, `create_date`, `update_date`) VALUES (1,1,'여행후기',1,'재미있었다링',0,'2022-11-09 21:14:58','2022-11-09 21:14:58');